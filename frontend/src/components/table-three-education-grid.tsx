    ...
    <div className="overflow-x-auto scrollbar-thin">
      <table className="w-full min-w-[1120px] border-collapse text-left text-xs">
        <thead className="text-center text-[11px] font-semibold uppercase text-ink">
          <tr><th colSpan={8} className="border-b border-line px-2 py-2 text-left font-bold tracking-wide">{province ? regionName : regionName.replace(/^(kabupaten|kota)\s+/i, '')}</th></tr>
          <tr className="border-y border-line bg-paper-inset"><th rowSpan={2} className="w-16 border-r border-line px-3 py-3">No.</th><th rowSpan={2} className="w-[340px] border-r border-line px-3 py-3">Variabel</th><th colSpan={3} className="border-r border-line px-3 py-2">Jumlah</th><th colSpan={3} className="px-3 py-2">Persentase</th></tr>
          <tr className="border-b border-line bg-paper-inset"><th className="w-36 border-l border-line px-2 py-2">Laki-laki</th><th className="w-36 border-l border-line px-2 py-2">Perempuan</th><th className="w-36 border-l border-line px-2 py-2">Laki-laki+Perempuan</th><th className="w-32 border-l border-line px-2 py-2">Laki-laki</th><th className="w-32 border-l border-line px-2 py-2">Perempuan</th><th className="w-36 border-l border-line px-2 py-2">Laki-laki+Perempuan</th></tr>
